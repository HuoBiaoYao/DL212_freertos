...
#define SDI12_C1_HIGH()           C1_TX_PORT->BSRRH = C1_TX_PIN;
#define SDI12_C1_LOW()            C1_TX_PORT->BSRRL = C1_TX_PIN;
#define SDI12_C2_HIGH()           C2_TX_PORT->BSRRH = C2_TX_PIN;  
#define SDI12_C2_LOW()            C2_TX_PORT->BSRRL = C2_TX_PIN;
