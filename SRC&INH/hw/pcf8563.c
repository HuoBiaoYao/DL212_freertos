...
_PCF8563_Time_Typedef sSysTime;
_PCF8563_Date_Typedef sSysDate;
/**
  *****************************************************************************
  * @Name   : 将BIN转换为BCD
  *
...
void PCF8563_SetPulseOut(unsigned int itv_sec){
	//PCF8563_Write_Byte(PCF8563_Address_Control_Status_1, 0x20); 
  PCF8563_Write_Byte(PCF8563_Address_Control_Status_2, 0x11);//1:set TI_TP(pulse);1:set TIE
  PCF8563_Write_Byte(PCF8563_Address_Timer, 0x82);//8->set TE;0->4096HZ  1->64HZ  2->1HZ  3->1/60HZ 
  PCF8563_Write_Byte(PCF8563_Address_Timer_VAL,itv_sec); 
