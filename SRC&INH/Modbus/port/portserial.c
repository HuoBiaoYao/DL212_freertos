...
BOOL xMBPortSerialInit( UCHAR ucPort, ULONG ulBaudRate, UCHAR ucDataBits, eMBParity eParity )
{
    ...
    if( xResult != FALSE )
    {
        ...
        RCC_APB2PeriphClockCmd(MB_UART_PORT_CLOCK | MB_UART_CLOCK, ENABLE);
        ...
        GPIO_PinAFConfig(MB_UART_TX_PORT,GPIO_PinSource9,GPIO_AF_USART1);
        GPIO_PinAFConfig(MB_UART_TX_PORT,GPIO_PinSource10,GPIO_AF_USART1);
